...
function dh_available_plots(&$site_meta=array(), &$link_to=array()) {
  ...
  <?php if (!empty($plot_map_id)) { 
    ...
    <div id="dh_plot_availability" class="plot-availability columns <?php echo $count ?>-plot-site <?php echo $size; ?>-site xv box">
    ...
    <?php } ?>
      ...
      <div class="legend aside">
        ...
        <ul>
          ...
          <li class="h2b"><?php echo dh_get_svg(array('icon' => 'h2b')); ?> Help to Buy available</li>
        </ul>
      </div>
